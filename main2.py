...
folder_path = "/home/lucas/Documents/Proyecto_Integrador/PI/segundo_semestre/3-12-25"
...
folder = "/home/lucas/Documents/Proyecto_Integrador/PI/segundo_semestre/3-12-25/"
sample_count = "20000000"  # Nota: se pasa como cadena, ya que se envía desde la línea de comandos
source = "source.xml"
...
for i in range(batches):
    ...
    cmd = ["/home/lucas/Documents/Proyecto_Integrador/PI/main", "-f", folder, "-n", sample_count, "-s", source, "-r", generate_filename(result, i)]
    ...
    SurfaceSourceFile = kds.SurfaceSourceFile(generate_filename(result, i)+".gz")
    ...
    kds.create_source_file(df, generate_filename("sint_source.h5",i))
    del df
    fuente_sintetica = [generate_filename("sint_source.h5",i)]
    run_simulation(fuente_sintetica, geometria, z0, cantidad, generate_filename(statepoint_name, i))