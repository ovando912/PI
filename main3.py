...
for i in range(batches):
    ...
    sp = openmc.StatePoint(generate_filename("statepoint_sintetico.h5",i))
...
factor = len(df_original_total) / 100
...
factor_normalizacion = 0.04163102222222222
axs_flujo[0, 0].plot(
    df_original_total["z"][z_min:z_max] / factor,
