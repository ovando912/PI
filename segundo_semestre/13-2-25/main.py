...
path = "/home/lucas/Documents/Proyecto_Integrador/PI/segundo_semestre/13-2-25"
source_path = (
...
axs[0, 2].plot(
    df_sintetico_espectro_total["E_min"]
    + 0.5
    * (df_sintetico_espectro_total["E_max"] - df_sintetico_espectro_total["E_min"]),
    df_sintetico_espectro_total["mean"] * factor_normalizacion,
    label="Sintético",
)
...
if geometria[0]:
    ...
    axs[1, 2].plot(
        df_sintetico_espectro_vacio["E_min"]
        + 0.5
        * (df_sintetico_espectro_vacio["E_max"] - df_sintetico_espectro_vacio["E_min"]),
        df_sintetico_espectro_total["mean"] * factor_normalizacion
        - df_sintetico_espectro_vacio["mean"] * factor_normalizacion,
        label="Sintético",
    )
