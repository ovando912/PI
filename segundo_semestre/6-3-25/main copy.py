...
# path = "/home/lucas/Documents/Proyecto_Integrador/PI/segundo_semestre/6-3-25"
# source_path = (
...
SurfaceSourceFile = kds.SurfaceSourceFile("/home/lucas/Documents/Proyecto_Integrador/PI/segundo_semestre/6-3-25/test.mcpl.gz")
df = SurfaceSourceFile.get_pandas_dataframe()
del SurfaceSourceFile
kds.create_source_file(df, "sintetico.h5")


fuente_sintetica = ["sintetico.h5"]

run_simulation(fuente_sintetica, geometria, z0, 20000000)
